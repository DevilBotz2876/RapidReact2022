...
import bhs.devilbotz.commands.shooter.ShooterSet;
import bhs.devilbotz.commands.shooter.ShooterStart;
    ...
    private void configureButtonBindings() {
        ...
        new JoystickButton(joy_two, 8)
         ...
         new JoystickButton(joy_two, 9)
                .toggleWhenPressed(new ShooterStart(shooter));

        new JoystickButton(joy_two, 10)
                .toggleWhenPressed(new ShooterVoltage(shooter));

        new JoystickButton(joy_two, 11)
                .toggleWhenPressed(new ShooterSet(shooter, 1000));
